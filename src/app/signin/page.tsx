...
export default function Signin(): JSX.Element {
      ...
      const variantsExit = {
        ...
        exit: { opacity: 1, x: -500 }, // Adjust the x value for sliding effect
      };
      const variantsExit1 = {
        hidden: { opacity: 1, x: -500 },
        visible: { opacity: 1, x: 0 },
  ...
  return (
        ...
        <motion.div className=" g-6 flex h-screen flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200"
              ...
              <div className="g-0 lg:flex lg:flex-wrap">
                ...
                <motion.div
                 variants={variantsExit1}
                  className="flex rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none bg-[#1F1F47] z-10"
                  style={{
                    background:
                ...
                >
                  <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                    ...
                    <h1 className="md:text-[50px] font-black">Login Your Account.</h1>
